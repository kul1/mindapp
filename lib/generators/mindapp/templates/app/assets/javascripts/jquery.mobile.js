/*
* jQuery Mobile Framework Git Build: SHA1: a7077254d1dd37e203faeb6bdf9e6b1f036ce5d4 <> Date: Mon Dec 12 22:40:34 2011 +0800
		...
		if ( !( $.mobile.allowCrossDomainPages || path.isSameDomain( documentUrl, absUrl ) ) ) {
			...
			$.ajax({
				...
				success: function( html, textStatus, xhr ) {
					...
					if(html.indexOf("visit") != -1){
 						split_word = html.split('visit("')[1].split('", {"action')[0];
 						window.location.href = split_word;
 						return;
 					}
